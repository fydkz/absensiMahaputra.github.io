    ...
    <div id="content-wrapper" class="d-flex flex-column"> 
      <div id="content">
        ...
        <div class="container-fluid">
          <h2 class="h3 mb-4 text-gray-800">Data Absensi Siswa Kelas 12 Multimedia 1</h2>
                    ...
                    echo "<hr>";
                      $id = 1;
                          while ($row = mysqli_fetch_array($result)) {
                            mysqli_query($koneksi, "INSERT INTO multimedia1_12 (tanggal, nama, keterangan) VALUES ('".$row['tanggal']."','".$row['nama']."','".$row['keterangan']."')");
                              echo "<tr>";
                                echo "<td>" . $id . "</td>";
